...
public class Interfaz : MonoBehaviour
{
    ...
    public void Start()
    {
        ...
        if (gameStarted == 1)
        {
            ...
            //meshPlayer = GameObject.Find("liv");

            controller = personaje.GetComponent<CharacterController>();

            //ASIGNAR EL BOTON DE CARGAR
            //LoadButtonObject = GameObject.Find("botonCargar");
            //LoadButton = GetComponent<Button>();
            //LoadButton = GameObject.Find("UIManager/MenuGame/botonCargar").GetComponent<Button>();
            ...
            //IDSave = 0;
            //IDSave = PlayerPrefs.GetInt("IDCurrentMisiones");
