...
public class QuestUIManager : MonoBehaviour
{
    ...
    public GameObject questLogPanel; //lista de misiones
    ...
    */
    ...
    /*//CALLED FROM ITEM OBJECT
    public void CheckItem(ItemObject itemObject)
    {
        //ItemManager.itemManager.currentItemtList = itemObject;
        ItemManager.itemManager.ItemRequest(itemObject);
    }*/
    ...
    void FillQuestButtons()
    {
        ...
        foreach (Quest activeQuest in activeQuests)
        {
            ...
            //qBScript.questTitle.text = "PRUEBAAA";

            //print("activeQuest.id = " + activeQuest.id);
            //print("activeQuest.title = " + activeQuest.title);
            ...
            if (NPCQuestObject.receivableQuestIDs.Count >= 1)
            {
                foreach (int values in NPCQuestObject.receivableQuestIDs)
                {
                    ...
                    for (int i = 0; i < QuestManager.questManager.questList.Count; i++)
                    {
                        if (values == QuestManager.questManager.questList[i].id && QuestManager.questManager.questList[i].progress == Quest.QuestProgress.ACCEPTED)
                        {
                            print("entrego la mision questID: " + values);
